## code to prepare `tab4` dataset goes here
require(dplyr)
require(stringr)
require(readr)
require(tidyr)
tab4 <- readxl::read_excel("./rawdatafiles/Data for MixSIAR.xlsx",
                           sheet = "OM Monk-Time Comparison") %>%
...
usethis::use_data(tab4, overwrite = TRUE)
