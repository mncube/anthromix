## code to prepare `tab6` dataset goes here
require(dplyr)
require(stringr)
require(readr)
require(tidyr)
tab6 <- readxl::read_excel("./rawdatafiles/Data for MixSIAR.xlsx",
                           sheet = "SM Peasant-Time Comparison") %>%
...
usethis::use_data(tab6, overwrite = TRUE)
