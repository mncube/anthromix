## code to prepare `tab8` dataset goes here
require(dplyr)
require(stringr)
require(readr)
require(tidyr)
tab8 <- readxl::read_excel("./rawdatafiles/Data for MixSIAR.xlsx",
                           sheet = "Tirup Peasant-Time Comparison") %>%
...
usethis::use_data(tab8, overwrite = TRUE)
