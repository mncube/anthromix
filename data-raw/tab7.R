## code to prepare `tab7` dataset goes here
require(dplyr)
require(stringr)
require(readr)
require(tidyr)
tab7 <- readxl::read_excel("./rawdatafiles/Data for MixSIAR.xlsx",
                           sheet = "Ribe Peasant-Time Comparison") %>%
...
usethis::use_data(tab7, overwrite = TRUE)
