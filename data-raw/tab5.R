## code to prepare `tab5` dataset goes here
require(dplyr)
require(stringr)
require(readr)
require(tidyr)
tab5 <- readxl::read_excel("./rawdatafiles/Data for MixSIAR.xlsx",
                           sheet = "OM Elite-Time Comparison") %>%
...
usethis::use_data(tab5, overwrite = TRUE)
